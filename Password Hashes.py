"""
    Kata source :
        ...
        https://www.codewars.com/kata/password-hashes/train/python/5d2fa574e3ab9300258ca57e
    ...
    As a side note, md5 can be exploited, so never use it for anything secure. The reason I used it in this kata is
        simply because it is a very common hashing algorithm and many people will recognize the name.
